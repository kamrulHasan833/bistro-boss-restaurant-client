...
function Testimonial({ testimonial }) {
  const { name, rating: intRating, details } = testimonial;
  const [rating, setRating] = useState(intRating);
        ...
        <div>
          <div className="flex justify-center mt-3 mb-3">
            <svg
              ...
              viewBox="0 0 100 100"
              fill="none"
              className=" w-12 h-12 md:w-16 md:h-16 lg:w-[100px] lg:h-[100px]"
            >
              <path
          ...
          <p className="text-desc-color mb-1 ">{details}</p>
          <h3 className="text-xl md:text-2xl lg:text-3xl font-medium text-primary-color ">
            {name}
          </h3>
        </div>
      </div>
